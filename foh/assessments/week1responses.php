...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 1 Assessment Responses (FOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/foh/front-of-house.php">Week 1 Assessment Responses (FOH)</a>
            </div>
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/foh/assessments/week1.php" role="button" style="margin-left: 5px; ">Go Back</a>
            </div>
        </nav>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <div class="card">
                    <div class="card-header">
                        <b>Question #1 Responses - Where can personal items be kept?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            ...
                            $sql = "SELECT * FROM w1_responses_foh";
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #2 Responses - Where do you print date label stickers from?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #3 Responses - List 3 items that need date label stickers.</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #4 Responses - Where do you store employee drinks?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #5 Responses - Can you put a can of monster on the drink shelf? Why?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #6 Responses - Can you put a bottle of water on the drink shelf? Why?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #7 Responses - What drinks are allowed on the drink shelf?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #8 Responses - Are items allowed to be stored on the floor?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #9 Responses - Can chemicals be left on the counter?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #10 Responses - What color scrub brush, squeegee, and mop are for front of house?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #11 Responses - What color scrub brush, squeegee, and mop are for bathrooms?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #12 Responses - Are you allowed to wear anything on your wrists?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
