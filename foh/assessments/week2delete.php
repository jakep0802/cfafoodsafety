...
if(isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $sql = "DELETE FROM w2_responses_foh WHERE id = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)) {
        ...
        if(mysqli_stmt_execute($stmt)) {
            header("location: week2responses.php");
            exit;
        } else {
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 2 Assessment Delete Response (FOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/foh/front-of-house.php">Week 2 Assessment Delete Response (FOH)</a>
            </div>
            
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/foh/assessments/week2responses.php" role="button" style="margin-left: 5px; ">Go Back</a>
            </div>
        </nav>
                        ...
                        <div class="col-spacing-custom">
                            <div class="alert" style="margin-bottom: unset;">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="/foh/assessments/week2responses.php" class="btn btn-secondary" style="margin-left: 5px;">No</a>
                                </div>
                            </div>
                        </div>
                    </div>
