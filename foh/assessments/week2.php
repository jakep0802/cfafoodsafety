...
$user_id = $_SESSION["id"];
$first_name = $last_name = $q1_response = $q2_response = $q3_response = $q4_response = $q5_response = $q6_response = $q7_response = $q8_response = $q9_response = $q10_response = "";
$first_name_err = $last_name_err = $q1_response_err = $q2_response_err = $q3_response_err = $q4_response_err = $q5_response_err = $q6_response_err = $q7_response_err = $q8_response_err = $q9_response_err = $q10_response_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["first_name"]))) {
        ...
        $sql = "SELECT id FROM w2_responses_foh WHERE first_name = ?";
    ...
    if(empty($first_name_err) && empty($last_name_err) && !$response_err_bool) {
        $sql = "INSERT INTO w2_responses_foh (user_id, first_name, last_name, q1_response, q2_response, q3_response, q4_response, q5_response, q6_response, q7_response, q8_response, q9_response, q10_response) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        if($stmt = mysqli_prepare($link, $sql)) {
        mysqli_stmt_bind_param($stmt, "issssssssssss", $param_user_id, $param_first_name, $param_last_name, $param_q1_response, $param_q2_response, $param_q3_response, $param_q4_response, $param_q5_response, $param_q6_response, $param_q7_response, $param_q8_response, $param_q9_response, $param_q10_response);
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 2 Assessment (FOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/foh/front-of-house.php">Week 2 Assessment (FOH)</a>
            </div>
            
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/foh/assessments/week2responses.php" role="button" style="margin-right: 5px; ">View Responses</a>
            ...
            <div class="card">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Why must drinks be stored on the drink shelf with a straw and a lid?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Why are items not allowed to be stored on the ground?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Why do we use red to signify bathrooms and blue to signify front of house/dining room?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Why are you not allowed to wear anything on your wrists?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>List 5 items that need date label stickers.</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What should you check for when bringing a tray of food to the front?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What shelves are you supposed to store dirty dishes on in the back of house?</label>
