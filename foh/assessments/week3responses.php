...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 3 Assessment Responses (FOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/foh/front-of-house.php">Week 3 Assessment Responses (FOH)</a>
            </div>
            
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/foh/assessments/week3.php" role="button" style="margin-left: 5px; ">Go Back</a>
            </div>
        </nav>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <div class="card">
                    <div class="card-header">
                        <b>Question #1 Responses - List 7 items that need date label stickers.</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            ...
                            $sql = "SELECT * FROM w3_responses_foh";
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #2 Responses - When do you need to place a date label sticker on an individual item?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #3 Responses - How should you pull lemonade and tea from the walk-in cooler?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #4 Responses - Can you pour a drink down the handwashing sink?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #5 Responses - What are handwashing sinks for?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #6 Responses - Why are you supposed to store dirty dishes on the top two shelves?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #7 Responses - Where do you store employee drinks?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #8 Responses - How must you store employee drinks?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #10 Responses - Where must chemicals be stored at?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #11 Responses - What color scrub brush, squeegee, and mop are for bathrooms and front of house/dining room?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #12 Responses - What are you allowed to wear on your wrists?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
