...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["first_name"]))) {
        ...
        $sql = "SELECT id FROM w1_responses_foh WHERE first_name = ?";
    ...
    if(empty($first_name_err) && empty($last_name_err) && !$response_err_bool) {
        $sql = "INSERT INTO w1_responses_foh (user_id, first_name, last_name, q1_response, q2_response, q3_response, q4_response, q5_response, q6_response, q7_response, q8_response, q9_response, q10_response, q11_response, q12_response, q13_response) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 1 Assessment (FOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark navbar-custom bg-dark">
            <div>     
                ...
                <a class="navbar-brand" href="/foh/front-of-house.php">Week 1 Assessment (FOH)</a>
            </div>
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/foh/assessments/week1responses.php" role="button" style="margin-right: 5px; ">View Responses</a>
            ...
            <div class="card">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Where can personal items be kept?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Where do you print date label stickers from?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>List 3 items that need date label stickers.</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Can chemicals be left on the counter?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What color scrub brush, squeegee, and mop are for front of house?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What color scrub brush, squeegee, and mop are for bathrooms?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Are you allowed to wear anything on your wrists?</label>
