...
$user_id = $_SESSION["id"];
$first_name = $last_name = $q1_response = $q2_response = $q3_response = $q4_response = $q5_response = "";
$first_name_err = $last_name_err = $q1_response_err = $q2_response_err = $q3_response_err = $q4_response_err = $q5_response_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["first_name"]))) {
        ...
        $sql = "SELECT id FROM w3_responses_boh WHERE first_name = ?";
    ...
    if(empty($first_name_err) && empty($last_name_err) && !$response_err_bool) {
        $sql = "INSERT INTO w3_responses_boh (user_id, first_name, last_name, q1_response, q2_response, q3_response, q4_response, q5_response) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        
        if($stmt = mysqli_prepare($link, $sql)) {
        mysqli_stmt_bind_param($stmt, "isssssss", $param_user_id, $param_first_name, $param_last_name, $param_q1_response, $param_q2_response, $param_q3_response, $param_q4_response, $param_q5_response);
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 3 Assessment (BOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/home.php">Week 3 Assessment (BOH)</a>
            </div>
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/boh/assessments/week3responses.php" role="button" style="margin-right: 5px; ">View Responses</a>
            ...
            <div class="card">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What is the correct way to rotate product?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What should you check when rotating product?</label>
