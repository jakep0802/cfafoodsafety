...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 2 Assessment Responses (BOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark navbar-custom bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/boh/back-of-house.php">Week 2 Assessment Responses (BOH)</a>
            </div>
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/boh/assessments/week2.php" role="button" style="margin-left: 5px; ">Go Back</a>
            </div>
        </nav>
        <div class="wrapper card-padding">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <div class="card">
                    ...
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            ...
                            $sql = "SELECT * FROM w2_responses_boh";
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #4 Responses - What products in your position of the store need position need stickers? (Select one position)</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #5 Responses - What are 3 examples of when you need to wash hands and change gloves?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #6 Responses - What color utensils correspond with what times of day? (List only the day-parts you work)</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #7 Responses - How often should counters be sanitized?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #8 Responses - How high is food allowed to be stored in the cold-well?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #9 Responses - Should there ever be an open spot in the cold-well? Why?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #10 Responses - If someone is wearing yellow gloves and apron, what part of the store should they be in? Are they allowed to leave that area?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #11 Responses - If someone is wearing yellow gloves and apron, can they leave the breading station with them on? Why?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <b>Question #12 Responses - Yellow scrub brush, squeege, and mop are the only cleaning utensils allowed where?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
                ...
                <div class="card" style="margin-bottom: 30px;">
                    <div class="card-header">
                        <b>Question #13 Responses - Do you have any questions about the food safety information you have learned so far? If so, what are they?</b>
                    </div>
                    <div class="row-custom">
                        <div class="col-spacing-custom">
                            <?php
