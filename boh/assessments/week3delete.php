...
if(isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    $sql = "DELETE FROM w3_responses_boh WHERE id = ?";
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 3 Assessment Delete Response (BOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/boh/back-of-house.php">Week 3 Assessment Delete Response (BOH)</a>
            </div>   
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/boh/assessments/week3responses.php" role="button" style="margin-left: 5px; ">Go Back</a>
            </div>
        </nav>
                        ...
                        <div class="col-spacing-custom">
                            <div class="alert" style="margin-bottom: unset;">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="/boh/assessments/week3responses.php" class="btn btn-secondary" style="margin-left: 5px;">No</a>
                                </div>
                            </div>
                        </div>
                    </div>
