...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["first_name"]))) {
        ...
        $sql = "SELECT id FROM w2_responses_boh WHERE first_name = ?";
    ...
    if(empty($first_name_err) && empty($last_name_err) && !$response_err_bool) {
        $sql = "INSERT INTO w2_responses_boh (user_id, first_name, last_name, q1_response, q2_response, q3_response, q4_response, q5_response, q6_response, q7_response, q8_response, q9_response, q10_response, q11_response, q12_response, q13_response, position) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        if($stmt = mysqli_prepare($link, $sql)) {
        mysqli_stmt_bind_param($stmt, "issssssssssssssss", $param_user_id, $param_first_name, $param_last_name, $param_q1_response, $param_q2_response, $param_q3_response, $param_q4_response, $param_q5_response, $param_q6_response, $param_q7_response, $param_q8_response, $param_q9_response, $param_q10_response, $param_q11_response, $param_q12_response, $param_q13_response, $param_position);
...
<html>
    <head>
        <meta charset="UTF-8"/>
        <title>Week 2 Assessment (BOH)</title>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <div>
                ...
                <a class="navbar-brand" href="/home.php">Week 2 Assessment (BOH)</a>
            </div>
            <div class="navbar-btn">
                <a class="btn btn-primary navbar-btn" href="/boh/assessments/week2responses.php" role="button" style="margin-right: 5px; ">View Responses</a>
            ...
            <div class="card">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What products in your position of the store need stickers? (Select one position)</label><br/>
                                <input type="radio" id="position" name="position" value="Primary"/>
                                <label for="position">Primary</label><br/>
                                <input type="radio" id="position" name="position" value="Nuggets"/>
                                <label for="position">Nuggets</label><br/>
                                <input type="radio" id="position" name="position" value="Breading & Hennys"/>
                                <label for="position">Breading & Hennys</label><br/>
                                <input type="radio" id="position" name="position" value="Prep"/>
                                <label for="position">Prep</label><br/>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What are 3 examples of when you need to wash hands and change gloves?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>What color utensils correspond with what times of day? (List only the day-parts you work)</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>How often should counters be sanitized?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>How high is food allowed to be stored in the cold-well?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Should there ever be an open spot in the cold-well? Why?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>If someone is wearing yellow gloves and apron, what part of the store should they be in? Are they allowed to leave that area?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>If someone is wearing yellow gloves and apron, can they leave the breading station with them on? Why?</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row-response justify-content-center">
                            <div class="form-group">
                                <label>Yellow scrub brush, squeege, and mop are the only cleaning utensils allowed where?</label>
